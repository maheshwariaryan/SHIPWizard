...
os.environ["OPENAI_API_KEY"] = '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'
...
You, Your means the Covered Student.
        ...
        answerAgent = Agent(
            ...
            backstory="You are an AI agent that will answer user questions using the definitions provided. " +
                        ...
                        "If the answer is not found in the definitions, provide a message saying that the answer is not found." +
                        "DO NOT make up information that is not in the definitions, simply say answer not found." +
        ...
        answerTask = Task(
            ...
            agent=answerAgent,
            expected_output="A definition of the term the user asked about and opinionally a few examples, or answer not found",
        )
